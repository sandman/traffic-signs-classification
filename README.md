...
### My Solution for the Traffic sign recognition project of Udacity's Self-driving car nanodegree Term 1.
...
Basic summary of the data set yields the following view:
